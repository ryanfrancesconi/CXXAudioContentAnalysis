...
/*! \brief class for audio blocking, supports both an audio file or an audio
 * buffer as source to block
 */
class CBlockAudioIf {
  public:
    ...
    \return float
    */
    static Error_t create(CBlockAudioIf *&pCInstance, CAudioFileIf *pCAudioFile,
    ...
    \return float
    */
    static Error_t create(CBlockAudioIf *&pCInstance, const float *pfAudioBuff,
                          long long iAudioLength, int iBlockLength,
                          int iHopLength, float fSampleRate);
    ...
    */
    long long getNumBlocks() const { return m_iNumBlocks; };

    /*! returns number of samples
    \return number of samples for current audio
    */
    long long getLengthInSamples() const { return m_iAudioLength; };
    ...
    */
    float getTimeStamp(long long iBlockIdx) {
        return (m_iBlockLength / 2.F + iBlockIdx * m_iHopLength) /
               m_fSampleRate;
    }
