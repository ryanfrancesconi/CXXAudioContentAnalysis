...
template <class T> class CRingBuffer {
  public:
    ...
    */
    ...
    \param tNewValue the new value
    */
    void put(T tNewValue) { m_ptBuff[m_iWriteIdx] = tNewValue; }
    ...
    */
    void put(const T *ptNewBuff, int iLength) {
        ...
        std::memcpy(&m_ptBuff[m_iWriteIdx], ptNewBuff,
                    sizeof(T) * iNumValues2End);
        if ((iLength - iNumValues2End) > 0)
            std::memcpy(m_ptBuff, &ptNewBuff[iNumValues2End],
                        sizeof(T) *
                            (static_cast<long long>(iLength) - iNumValues2End));
    }

    /*! return the value at the current read index and increment the read
    pointer
    ...
    */
    ...
    /*! return the values starting at the current read index and increment the
    read pointer
    ...
    */
    void get(T *ptBuff, int iLength) const {
        ...
        if ((iLength - iNumValues2End) > 0)
            std::memcpy(&ptBuff[iNumValues2End], m_ptBuff,
                        sizeof(T) *
                            (static_cast<long long>(iLength) - iNumValues2End));
    }
    ...
    \return int
    */
    int getWriteIdx() const { return m_iWriteIdx; }
    ...
    */
    ...
    \return int
    */
    int getReadIdx() const { return m_iReadIdx; }
    ...
    */
    ...
    /*! returns the number of values currently buffered (note: 0 could also mean
    the buffer is full!)
    \return int
    */
    ...
    \return int
    */
    int getLength() const { return m_iBuffLength; }
