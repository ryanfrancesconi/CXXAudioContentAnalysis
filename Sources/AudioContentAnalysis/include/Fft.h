...
class CFft {
  public:
    ...
    /*! defines the window function to use -- a custom window can also be used
     * (\sa overrideWindow) */
    ...
    \return Error_t
    */
    Error_t init(int iBlockLength, int iZeroPadFactor = 1,
                 WindowFunction_t eWindow = kWindowHann,
                 Windowing_t eWindowing = kPreWindow);
    ...
    */
    ...
    /*! perform the FFT
    \param pfSpectrum: output result of length iBlockLength * iZeroPadFactor
    (\sa initInstance)
    ...
    */
    ...
    /*! perform IFFT
    \param pfOut: time domain output signal of length iBlockLength *
    iZeroPadFactor (\sa initInstance)
    \param pfSpectrum: input spectrum of length iBlockLength * iZeroPadFactor
    (\sa initInstance)
    \return Error_t
    */
    ...
    \param pfMag: resulting magnitude spectrum of length (iBlockLength *
    iZeroPadFactor)/2+1 (\sa initInstance)
    \param pfSpectrum: input spectrum of length iBlockLength * iZeroPadFactor
    (\sa initInstance)
    \return Error_t
    */
    ...
    \param pfPhase: resulting phase spectrum of length (iBlockLength *
    iZeroPadFactor)/2+1 (\sa initInstance)
    \param pfSpectrum: input spectrum of length iBlockLength * iZeroPadFactor
    (\sa initInstance)
    \return Error_t
    */
    ...
    \param pfReal: resulting real part of length (iBlockLength *
    iZeroPadFactor)/2+1 (\sa initInstance)
    \param pfImag: resulting imaginary part of length (iBlockLength *
    iZeroPadFactor)/2 (\sa initInstance)
    \param pfSpectrum: input spectrum of length iBlockLength * iZeroPadFactor
    (\sa initInstance)
    \return Error_t
    */
    Error_t splitRealImag(float *pfReal, float *pfImag,
                          const complex_t *pfSpectrum) const;

    /*! merge real and imaginary parts into complex spectrum
    \param pfSpectrum: resulting spectrum of length iBlockLength *
    iZeroPadFactor (\sa initInstance)
    \param pfReal: input real part of length (iBlockLength * iZeroPadFactor)/2+1
    (\sa initInstance)
    \param pfImag: input imaginary part of length (iBlockLength *
    iZeroPadFactor)/2 (\sa initInstance)
    \return Error_t
    */
    Error_t mergeRealImag(complex_t *pfSpectrum, const float *pfReal,
                          const float *pfImag) const;
    ...
    */
    void multiply_I(complex_t *pfSrc1DestSpectrum,
                    const complex_t *pfSrc2Spectrum) const;
  ...
  private:
    ...
    bool m_bIsInitialized =
        false; //!< flag indicating if the instance is initialized
