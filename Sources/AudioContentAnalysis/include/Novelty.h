...
/*! \brief class for computation of a magnitude Novelty from either a file or a
 * vector
 */
class CNoveltyIf {
  public:
    ...
    \return Error_t
    */
    static Error_t create(CNoveltyIf *&pCInstance, Novelty_t eNoveltyIdx,
                          const std::string &strAudioFilePath,
                          int iBlockLength = 4096, int iHopLength = 512);
    ...
    */
    static Error_t create(CNoveltyIf *&pCInstance, Novelty_t eNoveltyIdx,
                          ...
                          float fSampleRate, int iBlockLength = 4096,
                          int iHopLength = 512);
    ...
    */
    ...
    /*! performs the Novelty computation for 1 dimensional Noveltys and writes
    the result
    \param pfNovelty (user-allocated, to be written, dimensions from
    CNoveltyIf::getNumBlocks)
  ...
  protected:
    ...
    CNoveltyFromBlockIf *m_pCNovelty =
        0; //!< instance for instantaneous novelty extraction
