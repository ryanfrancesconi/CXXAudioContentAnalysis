...
/*! \brief class for computation of a magnitude Pitch from either a file or a
 * vector
 */
class CPitchIf {
  public:
    ...
    \return Error_t
    */
    static Error_t create(CPitchIf *&pCInstance, PitchExtractors_t ePitchIdx,
    ...
    */
    ...
    /*! performs the Pitch computation for 1 dimensional Pitchs and writes the
    result
    \param pfPitch (user-allocated, to be written, dimensions from
    CPitchIf::getPitchDimensions)
    \return Error_t
    */
  ...
  protected:
    ...
    CPitchFromBlockIf *m_pCPitch =
        0; //!< class for extracting f0 from block of data

    CPitchAuditory *m_pCAuditory =
        0; //!< instace for auditory pitch tracking (the other pitch trackers
           //!< don't need a time dependent implementation)
