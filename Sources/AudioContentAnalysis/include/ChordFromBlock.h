...
class CChordFromBlockIf {
  public:
    ...
    \return Error_t
    */
    static Error_t create(CChordFromBlockIf *&pCInstance, int iMagSpecLength,
    ...
    */
    ...
    \param pfChordProb resulting chord probabilities (user allocated, length
    kNumChords)
  ...
  protected:
    ...
    void genTemplateMatrix_(); //!< chord templates for this similarity based
                               //!< chord detection
    ...
    CFeatureFromBlockIf *m_pCFeatureExtractor =
        0; //!< instance for pitch chroma extraction
};
