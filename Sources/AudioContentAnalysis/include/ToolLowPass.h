...
class CSinglePoleLp {
  public:
    ...
    */
    ...
    \return float
    */
    float getFilterParam() const { return m_fAlpha; }
    ...
    */
    ...
    \param fIntegrationTimeInS integration time in seconds (the higher, the more
    low pass)
...
class CMovingAverage {
  public:
    ...
    */
    ...
    \param iFilterLength length of the moving average filter (the longer the
    more lowpass)
    \return int
    */
    ...
    \return int
    */
    int getFilterParam() const { return m_pCRingBuff->getNumValuesInBuffer(); }
    ...
    */
    Error_t process(float *pfOut, const float *pfIn, long long iLenBuff) {
        ...
        // recursive implementation - beware of potential error propagation due
    ...
    */
    void filtfilt(float *pfOut, const float *pfIn, long long iLenBuff) {
        ...
        float *pfTmpBuff = 0;
        CVector::alloc(pfTmpBuff,
                       iLenBuff + 2 * static_cast<long long>(iLenFilter));
        ...
        // reverse tail
        for (auto i = iLenBuff + 2 * static_cast<long long>(iLenFilter) - 1;
             i >= iLenBuff + iLenFilter; i--) {
            float fZero = 0.F;
