...
class CGmmClassifier : public CClassifierBase {
  public:
    ...
    \param iNumObservations number of observations (columns in the feature
    matrix)
    \return Error_t
    */
  ...
  private:
    ...
    */
    ...
    int *m_piClassLabels =
        0; //!< preallocated vector containing the unique set of classes
    ...
    CGmmResult **m_ppCGmmResult =
        0; //!< array holding the individual Gmm models (length m_iNumClasses)
};
