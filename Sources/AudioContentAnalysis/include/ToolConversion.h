...
class CConversion {
  public:
    ...
    \return mel value
    */
    static float convertFreq2Mel(float fInHz,
                                 MelConversionFunctions_t eFunc = kFant);
    ...
    */
    static float convertMel2Freq(float fMel,
                                 MelConversionFunctions_t eFunc = kFant);
    ...
    \return void
    */
    static void convertFreq2Mel(float *pfMel, const float *pffInHz,
                                int iLengthBuff,
                                MelConversionFunctions_t eFunc = kFant);

    /*! converts a mel array to a frequency array
    \param pffInHz output frequency values in Hz (length iLenghBuff, to be
    written)
    ...
    \return void
    */
    static void convertMel2Freq(float *pffInHz, const float *pfMel,
                                int iLengthBuff,
                                MelConversionFunctions_t eFunc = kFant);
    ...
    \return Bark value
    */
    static float convertFreq2Bark(float fInHz,
                                  BarkConversionFunctions_t eFunc = kSchroeder);
    ...
    \return frequency value in Hz
    */
    static float convertBark2Freq(float fBark,
                                  BarkConversionFunctions_t eFunc = kSchroeder);
    ...
    \param eFunc index for conversion function selection
    */
    static void convertFreq2Bark(float *pfBark, const float *pffInHz,
                                 int iLengthBuff,
                                 BarkConversionFunctions_t eFunc = kSchroeder);
    ...
    \param eFunc index for conversion function selection
    */
    static void convertBark2Freq(float *pffInHz, const float *pfBark,
                                 int iLengthBuff,
                                 BarkConversionFunctions_t eFunc = kSchroeder);
    ...
    */
    ...
    \param fA4InHz tuning (reference) frequency in Hz
    */
    static void convertFreq2Midi(float *pfMidi, const float *pffInHz,
                                 int iLengthBuff, float fA4InHz = 440.F) {
        assert(pfMidi);
        assert(pffInHz);
    ...
    */
    ...
    \param pffInHz output buffer with frequency values in Hz (length
    iLengthBuff)
    \param pfMidi input buffer (length iLengthBuff, to be written)
    \param iLengthBuff length of buffers
    \param fA4InHz tuning (reference) frequency in Hz
    */
    static void convertMidi2Freq(float *pffInHz, const float *pfMidi,
                                 int iLengthBuff, float fA4InHz = 440.F) {
        assert(pfMidi);
        assert(pffInHz);
        assert(iLengthBuff > 0);
    ...
    */
    static float convertFreq2Bin(float fInHz, int iFftLength,
    ...
    \param pfBin output buffer with FFT bin indices (length iLengthBuff, to be
    written)
    ...
    \param fSampleRate sample rate frequency in Hz
    */
    static void convertFreq2Bin(float *pfBin, const float *pffInHz,
                                int iLengthBuff, int iFftLength,
                                float fSampleRate = 44100.F) {
        assert(pfBin);
        assert(pffInHz);
        assert(iLengthBuff > 0);
    ...
    */
    static float convertBin2Freq(float fBin, int iFftLength,
                                 float fSampleRate = 44100.F) {
        assert(fBin >= 0);
        assert(iFftLength >= 0);
    ...
    \param pffInHz frequency in Hz output buffer (length iLengthBuff, to be
    written)
    ...
    \param fSampleRate sample rate frequency in Hz
    */
    static void convertBin2Freq(float *pffInHz, const float *pfBin,
                                int iLengthBuff, int iFftLength,
                                float fSampleRate = 44100.F);
    ;
