...
class CKmeans {
  public:
    ...
    */
    ...
    /*! clusters the data
    \param piResult resulting cluster indices, starting with 0 (length iNumObs,
    user-allocated, to be written)
  ...
  private:
    ...
    */
    void compClusterMeans_(const float *const *const ppfFeatures,
                           const int *piResult);
    ...
    */
    ...
    \param ppfFeatures input matrix of dimesions iNumFeatures X iNumObs
    */
    void assignClusterLabels_(int *piResult,
