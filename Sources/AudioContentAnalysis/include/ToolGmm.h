...
/*! \brief class holding the result/details of a Gaussian Mixture Model created
 * with ::CGmm
 */
class CGmmResult {
    friend class CGmm;
  ...
  public:
    ...
    */
    ...
    /*! returns the dimensionality of each Gaussian, i.e., the number of
    features
    \return int
    */
    ...
    */
    ...
    \param ppfSigma to be written (user allocated, dimensions iNumFeatures X
    iNumFeatures)
    \param iGaussianIdx index of Gaussian
    */
  ...
  private:
    ...
    bool m_bIsInitialized =
        false; //!< indicates whether instance is initialized
};
...
class CGmm {
  public:
    ...
    \param pCResult class holding resulting mean, sigma, and priors, see class
    ::CGmmResult (user-allocated)
    ...
    \return Error_t
    */
    Error_t init(CGmmResult *pCResult, int iK, int iNumFeatures, int iNumObs,
                 int iMaxIter = 300);
    ...
    */
    ...
    \return Error_t
    */
    Error_t compGmm(CGmmResult *pCResult,
  ...
  private:
    ...
    */
    void initState_(const float *const *const ppfFeatures,
    ...
    \param pCCurrState class holding the current state variables
    */
    void compProbabilities_(const float *const *const ppfFeatures,
                            CGmmResult *pCCurrState);
    ...
    \param pCCurrState class holding the current state variables
    */
    void updateState_(const float *const *const ppfFeatures,
                      CGmmResult *pCCurrState);
    ...
    */
    ...
    float **m_appfClusterMeans[kNumStates] = {
        0}; //!< contains the current and previous cluster means

    float *m_apfProc[2] = {0}, //!< temporary pre-allocated memory buffer
        **m_appfSigma[2] =
            {0}, //!< temporary sigma matrices (m_iNumFeatures x m_iNumFeatures)
