...
/*! \brief class for computation of a chord progression from either a file or a
 * vector
 */
class CChordIf {
  public:
    ...
    \return Error_t
    */
    static Error_t create(CChordIf *&pCInstance,
                          const std::string &strAudioFilePath,
                          int iBlockLength = 8192, int iHopLength = 2048);
    ...
    \return Error_t
    */
    static Error_t create(CChordIf *&pCInstance, const float *pfAudio,
    ...
    */
    ...
    /*! performs the Chord computation for 1 dimensional Chords and writes the
    result
    \param peChord resulting chord indices (user-allocated, to be written,
    dimensions from CChordIf::getNumBlocks)
  ...
  protected:
    ...
    CChordFromBlockIf *m_pCChord =
        0;                     //!< instantaneous chord detection instance
    ...
    float **m_ppfChordProbs =
        0; //!< chord probabilities (chrods X observations)
